...
class TestRPSMultipleGame(unittest.TestCase):
    ...
    def test_update_csv(self):
        ...
        game_details = {'PlayerID': 'TestPlayer', 'PlayerChoice': 'R', 'ComputerChoice': 'S', 'Result': 1}
    ...
    def test_show_result(self):
        ...
        with patch('builtins.print') as mocked_print:
            ...
            mocked_print.assert_called_with('Joueur: R, Ordinateur: S, Résultat: Le joueur gagne')

    def test_load_history_with_file(self):
        # Mock data for testing
        mock_data = [
            {'PlayerID': 'Player1', 'PlayerChoice': 'R', 'ComputerChoice': 'S', 'Result': 1},
            {'PlayerID': 'Player2', 'PlayerChoice': 'S', 'ComputerChoice': 'R', 'Result': 2}
        ]
